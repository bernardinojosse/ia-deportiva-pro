...
def scaricaCampionato(id_liga):
    deportes = {"0": "soccer_italy_serie_a", "01": "soccer_mexico_ligamx", "02": "soccer_uefa_champions_league", "04": "soccer_england_league_1", "06": "soccer_spain_la_liga"}
    ...
    try:
        ...
        # Validación para evitar el error de "índices de cadena"
        ...
        print(f"Error en liga {id_liga}: {e}")
        return pd.DataFrame()
