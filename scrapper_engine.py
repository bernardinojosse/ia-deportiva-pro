...
def generar_pick_dinamico(q1, q2):
    ...
    if q1 <= 1.55: return "🔥 LOCAL IMPERDIBLE"
    if q2 <= 1.55: return "🚀 VISITA IMPERDIBLE"
    p1, p2 = 1/q1, 1/q2
...
def scaricaCampionato(id_liga):
    # Nombres técnicos validados para la API
    deportes = {
    ...
    # Región 'us' para casas de apuestas en México/Latam
...
def allFromCampionato(df): return df
